...
/*************************************************************************************************/
		...
		.def("canJoin", &CyUnit::canJoin, "bool (CyPlot* pPlot, int (SpecialistClassTypes) eSpecialist)")
...
//FfH Spell System: Added by Kael 07/23/2007
		...
		.def("canCast", &CyUnit::canCast, "bool (int spell, bool bTestVisible)")
			.def("canCastResurrect", &CyUnit::canCastResurrect, "bool (int spell)")
			.def("castResurrect", &CyUnit::castResurrect, "void (int spell)")
			.def("getDeathListTarget", &CyUnit::getDeathListTarget, "int ()")
			.def("setDeathListTarget", &CyUnit::setDeathListTarget, "void (int deathlist)")
