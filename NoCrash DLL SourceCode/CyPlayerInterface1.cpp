...
/*************************************************************************************************/
		...
		.def("isSpecialistClassValid", &CyPlayer::isSpecialistClassValid, "bool (int /*SpecialistClassTypes*/ iIndex)")
		.def("getSpecialistClassCount", &CyPlayer::getSpecialistClassCount, "bool (int /*SpecialistClassTypes*/ iIndex)")
