...
void CyCityPythonInterface2(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("getSpecialistClassCount", &CyCity::getSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex)")
		.def("alterSpecialistClassCount", &CyCity::alterSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex, int iChange)")
		.def("getMaxSpecialistClassCount", &CyCity::getMaxSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex)")
		.def("isSpecialistClassBlocked", &CyCity::isSpecialistClassBlocked, "bool (int /*SpecialistTypes*/ eIndex)")
		.def("setSpecialistClassBlocked", &CyCity::setSpecialistClassBlocked, "int (int /*SpecialistTypes*/ eIndex, bool iNewValue")
		.def("isSpecialistClassValid", &CyCity::isSpecialistClassValid, "bool (int /*SpecialistTypes*/ eIndex, int iExtra)")
		.def("getForceSpecialistClassCount", &CyCity::getForceSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex)")
		...
		.def("getFreeSpecialistClassCount", &CyCity::getFreeSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex")
		.def("setFreeSpecialistClassCount", &CyCity::setFreeSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex, iNewValue")
		.def("changeFreeSpecialistClassCount", &CyCity::changeFreeSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex, iChange")
		.def("getAddedFreeSpecialistClassCount", &CyCity::getAddedFreeSpecialistClassCount, "int (int /*SpecialistTypes*/ eIndex")
